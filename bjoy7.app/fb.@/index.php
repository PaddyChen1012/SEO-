...
<head>
   ...
   fbq('init', '908346584405245');
   fbq('track', 'PageView');
   </script>
   <noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=908346584405245&ev=PageView&noscript=1"/></noscript>
   <!-- End Meta Pixel Code -->
</head>
<body>
<main>
            ...
            <div class="regis-data">
               ...
               <form id="myform" method="post">
                  ...
                  <label>
                     ...
                     <input type="password" name="pwd" maxlength="16" autocomplete="off" placeholder="পাসওয়ার্ড" onfocus="this.placeholder=''" onblur="this.placeholder='পাসওয়ার্ড'" required>
...
switch ($data_info) {
   ...
   case 'common.parameter.illegal':
      ...
      break;
   case 'common.success':
      echo '<script>fbq("track", "CompleteRegistration");location.href="/suceful.html?user='. $data['username'].'";</script>';
