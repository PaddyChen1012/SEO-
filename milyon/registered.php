...
<head>
    ...
    <link rel="icon" href="images/milyonLOGO.webp" type="image/x-icon">
    <link rel="shortcut icon" href="images/milyonLOGO.webp" type="image/x-icon">
...
<body>
    <div class="container-fluid main-place p-0 registered vh-100">
        <div class="row position-relative h-100 mx-auto align-items-center justify-content-center align-items-md-center py-5 mb-0">
            <form  class="col-11 col-md-6 row position-relative data-box p-4 rounded-3" method="post">
