...
$data_captcha = send_data(
	$url = 'https://www.bjoy7.com/service/auth/captcha?t='. time(),
   $data = [
   ]
);
...
if ($dataCheck) {
   $data_list = send_data($url = 'https://www.bjoy7.com/service/member', $data);
}
?>
      ...
      <section id="register">
         ...
         <div class="regis-bg">
            <div class="regis-data">
               ...
               <div class="login-btn">
                  <a href="https://auth.smmovies.xyz/third-login?p=facebook&o=www.bjoy7.com&a=ATad01"><img src="./img/facebook.webp" alt=""></a>
                  <a href="https://auth.smmovies.xyz/third-login?p=google&o=www.bjoy7.com&a=ATad01"><img src="./img/google.webp" alt=""></a>
               </div>
...
<script>
   ...
   function event() {
      try {
         //自定义事件名称
         ANDROID_JS_BRIDGE.gree_register('af_register');
      }
   }
</script>
