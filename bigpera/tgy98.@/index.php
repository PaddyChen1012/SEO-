...
if (isset($_POST['phoneNumber']) && strlen($_POST['phoneNumber']) > 0){
   ...
   if (!preg_match("/^[0-9]{10,11}$/", $_POST['phoneNumber'])) {
      $erro_phone = 'လုပ်ဆောင်မှုမအောင်မြင်ပါ - ဖုန်းနံပါတ်တွင် 09 နှင့်စတင်၍ ဂဏန်း 10 မှ 11 လုံး ပါဝင်ရပါမည်။';
   }
}
else{
	$dataCheck = false;
	$phone_Vf = 'ဖုန်းနံပါတ်တွင် 09 နှင့်စတင်၍ ဂဏန်း 10 မှ 11 လုံး ပါဝင်ရပါမည်။';
}
...
<head>
   ...
   <script>
      ...
      fbq('init', '2408825469289260');
      fbq('track', 'PageView');
   </script>
   <noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=2408825469289260&ev=PageView&noscript=1"/></noscript>
   <!-- End Meta Pixel Code -->
   ...
   <section class="home">
      ...
      <div class="location" id="register">
         ...
         <form id="myform" method="post">
            <div class="user-box">
               <input id="username" type="text" name="username" maxlength="15" autocomplete="off" required="required">
               <label for="username">အကောင့်</label>
               <div class="<?php if ($name_Vf) { echo 'tip-info'; }else if ($erro_name){ echo 'error-info'; } ?>"><?php echo @$name_Vf; echo @$erro_name; ?></div>
            </div>
            <div class="user-box">
               <input id="pws" type="password" name="pwd" maxlength="15" autocomplete="off" required="required">
            ...
            <div class="user-box">
               <input id="tel" type="number" name="phoneNumber" autocomplete="off" required="required">
            ...
            <div class="user-box">
               <input id="num" type="number" name="captcha" autocomplete="off" required="required">
