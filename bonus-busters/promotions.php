...
<head>
    ...
    })(window,document,'script','dataLayer','GTM-5RDDZ8JC');</script>
...
<body>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5RDDZ8JC"
    ...
    <section>
        ...
        <div class="main">
            ...
            <div class="card">
                <a href="<?= $item['url'] ?>"><img src="<?= $item['promotionsImg'] ?>" alt="" srcset=""></a>
                ...
                <div class="card-body">
                    <div class="c-name">
                        ...
                        <div>Promotion：<a href="<?= $item['url'] ?>" class="btn-link">Claim</a></div>
                    </div>
