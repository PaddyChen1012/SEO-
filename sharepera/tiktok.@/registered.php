        ...
        <div class="row position-relative h-100 mx-auto align-items-center justify-content-center align-items-md-center mb-0">
            <form  class="col-11 col-md-6 row position-relative data-box m-0 p-4 rounded-3" method="post">
                ...
                <div class="col-12 text-center mt-2">
                    <input type="submit"  name="send" class="sumbit-btn border-0" value="Register" onclick="triggerClickEvent()">
                </div>
            </form>
        </div>
    </div>
...
<script>
    ...
    // Example Function to Trigger Click Event
    function triggerClickEvent() {
        if (window.ttq && typeof window.ttq.track === 'function') {
            window.ttq.track('CustomClickEvent', {
                button_name: 'Click Me', // Custom property: button_name
                category: 'Button Clicks', // Custom property: category
