...
<head>
   ...
   <link rel="shortcut icon" href="./img/favicon.ico" type="image/x-icon">
    ...
    <script>
        ...
        fbq('init', '262098376600983');
        fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=262098376600983&ev=PageView&noscript=1"/></noscript>
    <!-- End Meta Pixel Code -->
</head>
<body>
    ...
    <section id="regis-box">
        <h2>Registration</h2>
        <form id="myform" action="./suceful.html" method="post">
            <div class="user-box">
                <input id="username" type="text" name="username" required="" maxlength="16" autocomplete="off" title="">
                <label for="username">Username</label>
            </div>
            <div class="user-box">
                <input id="pws" type="password" name="pws" required="" maxlength="16" autocomplete="off" title="">
            ...
            <div class="user-box">
                <input id="num" type="text" name="captcha" required="" maxlength="6" autocomplete="off" title="">
                <label for="num">Confirmation code</label>
                <canvas id="mycanvas" width="150px" height="40px"></canvas>
            </div>
            <button type="submit">
                <span></span>
                <span></span>
