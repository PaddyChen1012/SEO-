...
$data_captcha = send_data(
	$url = 'https://www.betso88.live/service/auth/captcha?t=' . time(),
    $data = [
    ]
);
...
if ($dataCheck) {
    $data_list = send_data($url = 'https://www.betso88.live/service/member', $data);
    // ysTrackEvent('8mklhs');
}
// echo '<pre>';
...
<head>
    ...
    fbq('init', '1036737830658531');
    fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=1036737830658531&ev=PageView&noscript=1"/></noscript>
    <!-- End Meta Pixel Code -->
</head>
<body>
