...
<head>
    <!-- Google Tag Manager --> 
    <script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start': new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0], j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src= 'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f); })(window,document,'script','dataLayer','GTM-MJCSQ5H');</script> 
    <!-- End Google Tag Manager -->
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>7spin</title>
    <link rel="icon" href="./assets/icon_400x400.webp" type="image/x-icon">
    <link rel="shortcut icon" href="./assets/icon_400x400.webp" type="image/x-icon">
    <link rel="preload" href="./img_pc/NA7_LP_phone_noassets.webp" as="image"/>
    ...
    <?php
    // 检查当前URL中的查询参数
    if ($_SERVER['QUERY_STRING'] === 'btag=39996452_234055') {
        // 输出Meta Pixel代码
        ...
        echo 'fbq("init", "710225204283797");';
        echo 'fbq("track", "PageView");';
        echo '</script>';
        echo '<noscript><img height="1" width="1" style="display:none"';
        echo 'src="https://www.facebook.com/tr?id=710225204283797&ev=PageView&noscript=1"';
        echo '/></noscript>';
...
<body>
    <section id="top">
        <a class="btn-top" href="#top" style="display: none;"><img src="./assets/btn_img_top.webp" alt=""></a>
        <div id="leaves">
        ...
        <div class="page page-1 active">
            ...
            <a class="btn-link" href=""><img class="img-btn" src="./assets/btn1.webp" alt=""></a>
        </div>
        ...
        <div class="page page-3">
            <a class="btn-link" href=""><img class="btn-img-ferriswheel" src="assets/btn_img_ferriswheel.webp" alt=""></a>
            <div class="scroll-point"></div>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MJCSQ5H " height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript> 
