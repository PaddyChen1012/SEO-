...
<body>
    <main>
        <section>
            <img src="./images/Bjoy7_lp0124_1080x1920_01_bd.webp" class="bg-img" alt="">
            <div class="gradient-bg color-2"></div>
        </section>

        <section>
            <img src="./images/Bjoy7_lp0124_1080x1920_02_bd.webp" class="bg-img" alt="">
            <div class="gradient-bg color-3"></div>
        </section>
        
        <section id="register">
            <img src="./images/Bjoy7_lp0124_1080x1920_03_bd.webp" class="bg-img" alt="">
            <div class="regis-bg">
                <div class="regis-data">
                    <div class="login-btn">
                        <a href="https://auth.smmovies.xyz/third-login?p=facebook&o=www.bjoy7.com&a=HKA01"><img src="./images/facebook.webp" alt=""></a>
                        <a href="https://auth.smmovies.xyz/third-login?p=google&o=www.bjoy7.com&a=HKA01"><img src="./images/google.webp" alt=""></a>
                    </div>
                    <form id="myform" method="post">
                        <label>
                            <img src="./images/Regis-username_icon.webp" alt="">
                        ...
                        <label>
                            <img src="./images/Regis-phone-number_icon.webp" alt="">
                        ...
                        <label>
                            <img src="./images/Regis-password_icon.webp" alt="">
                    ...
                    <a class="confirm-btn" onclick="document.getElementById('myform').submit();">
                        <img src="./images/LP5_btn.webp" alt="">
                    </a>
                </div>
            </div>
        </section>
    ...
    <footer>
        <p>This game is suitable for ages 21+ only.</p>
        <div>
            <a href="./terms-and-conditions.html">About us</a>
            <a href="./terms-and-conditions.html">Terms and conditions</a>
            <a href="./terms-and-conditions.html">Privacy Policy</a>
            <a href="./terms-and-conditions.html">Cancellation and refund policy</a>
        </div>
        <p>Copyright 2023 3 Bjoy7 All rights reseved</p>
    </footer>
